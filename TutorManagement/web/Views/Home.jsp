<%-- 
    Document   : Home
    Created on : 25-Oct-2023, 23:56:13
    Author     : ADMIN
--%>
                    ...
                    <div class="container">
                        <div class="row g-5 align-items-center">
                            <div class="col-lg-6">
                                ...
                                <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">EduMatch</span></h1>
                                <p class="mb-4">Welcome to EDUMATCH, your premier platform for connecting with qualified tutors and learners. Whether you're looking for a tutor or want to share your knowledge, we've got you covered. Start your learning journey today!</p>
                            ...
                            <c:if test="${(sessionScope.user.isActive != 1) && (sessionScope.user != null )}">
                                <a class="btn btn-primary py-3 px-5 mt-2" href="/PRJ301_SE1761_FA23_HE171380/EditControl">Active your account to explore more</a>
                            </c:if>
                            <c:if test="${sessionScope.user.isActive == 1}">
                                <a class="btn btn-primary py-3 px-5 mt-2" href="/PRJ301_SE1761_FA23_HE171380/LoadDBStd">Explore More</a>
                            </c:if>
                        ...
                        <div class="container-xxl py-5 px-0 wow zoomIn" data-wow-delay="0.1s">
                            <div class="row g-0">
                                <div class="col-md-12 bg-dark d-flex align-items-center">
                                    <div class="p-5">
            <c:if test="${(sessionScope.user.isActive == 1) && (sessionScope.user.rollNo == 2)}">
                -->                            <a class="btn btn-primary py-3 px-5 mt-2" href="/PRJ301_SE1761_FA23_HE171380/UploadRequest">Upload your request now to be tutored</a><!--
            </c:if>
        </div>
    </div>
