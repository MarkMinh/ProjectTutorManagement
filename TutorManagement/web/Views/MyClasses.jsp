                        ...
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="/PRJ301_SE1761_FA23_HE171380/ClassDetail?cid=${s.id}" class="btn btn-sm btn-primary rounded py-2 px-4" >Detail</a>  
                                    <a href="/PRJ301_SE1761_FA23_HE171380/EndClass?cid=${s.id}" class="btn btn-sm btn-dark rounded py-2 px-4" >End this class</a>                     
                                </div>
