 ...
 * @author ADMIN
 */
public class ReceivedControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ReceivedControl</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ReceivedControl at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
...
//        // filter
        ...
        list = DAO.INSTANCE.getAllRequestedByUser(user.getUsername());
        ...
        request.setAttribute("listStd", list);
        request.setAttribute("dao", DAO.INSTANCE);

        request.getRequestDispatcher("Views/Received.jsp").forward(request, response);
    } 
