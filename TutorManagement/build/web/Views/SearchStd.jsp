<%-- 
    Document   : SearchStd
    Created on : 29-Oct-2023, 00:16:20
    Author     : ADMIN
--%>
            ...
            <div class="container-xxl py-5">
                <div class="container">
                    ...
                    <form action="/PRJ301_SE1761_FA23_HE171380/SearchControl" method="post">
                        <div class="row g-5">
                            ...
                            <div class="col-4">
                                <div class="form-floating">
                                    <select class="form-select" name="provinceS" id="provinceSelect" onChange="loadDistricts()">
                        ...
                        <div class="col-4">
                            <div class="form-floating">
                                <select class="form-select" name="districtS" id="districtSelect" onChange="loadWards()">
                        ...
                        <div class="col-4">
                            <div class="form-floating">
                                <select class="form-select" name="gradeS" id="gradeS">
                                    <option value="999" ${(gradeS == g) ?'selected':''}>Select grade</option>
                                    <c:forEach items="${gradeLv}" var="g">
                                        <option value="${g}" ${(gradeS == g) ?'selected':''}>Grade ${g}</option>
                                    </c:forEach>
                                </select>             
                        ...
                        <div class="col-4">
                            <div class="form-floating">
                                <select class="form-select" name="genderS" id="genderS">
                                    <option value="999" ${(genderS.equals(""+ 999)) ?'selected':''}>Select gender</option>
                                    <option value="0"${(genderS.equals(""+ 0)) ?'selected':''}>Male</option>
                                    <option value="1" ${(genderS.equals(""+ 1)) ?'selected':''}>Female</option>
                                    <option value="2"${(genderS.equals(""+ 2)) ?'selected':''}>Others</option>
                                </select>             
                        ...
                        <div class="col-4">
                            <div class="form-floating">
                                <select class="form-select" name="subjectS" id="subjectS">
                                    <option value="999"${(subjectS.equals(""+ 999)) ?'selected':''}>Select subject</option>
                                    <c:forEach items="${subjects}" var="s">
                                        <option value="${s.id}"${(subjectS.equals(""+ s.id)) ?'selected':''}>${s.name}</option>
                                    </c:forEach>
                                </select>             
                        ...
                        <div class="col-md-4">    
                            <div class="form-floating">
                                <input type="number" class="form-control" name="moneyS" id="moneyS" value="${moneyS}" min=50000 max=1000000 step=1000>
                        ...
                        <div class="col-md-4">    
                            <div class="form-floating">
                                <input type="text" class="form-control" value="${nameS}" name="nameS" id="nameS">
