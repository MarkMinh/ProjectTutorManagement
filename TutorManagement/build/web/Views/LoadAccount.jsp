            ...
            <div class="container-xxl py-5">
                <div class="container">
                    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h1 class="mb-5">Your <span class="text-primary text-uppercase">users</span></h1>
                    </div>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h6 class="section-title text-center text-primary text-uppercase">Our Users</h6>
            <h1 class="mb-5">Explore Our <span class="text-primary text-uppercase">users</span></h1>
        </div>
                        ...
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0">User: ${s.username}</h5>             
                                </div>
                                
                                <div class="d-flex justify-content-between">
                                    <a href="/PRJ301_SE1761_FA23_HE171380/DetailAccount?uid=${s.username}" class="btn btn-sm btn-primary rounded py-2 px-4" >View Detail</a>                                    
                                </div>
